...
https://downloads.fennok.com/fensight-installer/FenSight-1.5.0-win-x64-installer.zip
...
`Get-FileHash "C:\path\to\FenSight-1.5.0-win-x64-installer.zip" -Algorithm SHA256`
